...
public class InfoControllerApi {
     ...
     */
    public okhttp3.Call fetchVersionGETCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call fetchVersionGETValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return fetchVersionGETCall(_callback);
    ...
    public AggregateSourceInfo fetchVersionGET() throws ApiException {
        ApiResponse<AggregateSourceInfo> localVarResp = fetchVersionGETWithHttpInfo();
    ...
    public ApiResponse<AggregateSourceInfo> fetchVersionGETWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = fetchVersionGETValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call fetchVersionGETAsync(final ApiCallback<AggregateSourceInfo> _callback) throws ApiException {

        okhttp3.Call localVarCall = fetchVersionGETValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<AggregateSourceInfo>(){}.getType();
