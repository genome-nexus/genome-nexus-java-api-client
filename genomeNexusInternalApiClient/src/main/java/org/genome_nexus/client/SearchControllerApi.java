...
public class SearchControllerApi {
     ...
     */
    public okhttp3.Call searchAnnotationByKeywordGETUsingGETCall(String keyword, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call searchAnnotationByKeywordGETUsingGETValidateBeforeCall(String keyword, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        return searchAnnotationByKeywordGETUsingGETCall(keyword, limit, _callback);
    ...
    public List<IndexSearch> searchAnnotationByKeywordGETUsingGET(String keyword, Integer limit) throws ApiException {
        ApiResponse<List<IndexSearch>> localVarResp = searchAnnotationByKeywordGETUsingGETWithHttpInfo(keyword, limit);
    ...
    public ApiResponse<List<IndexSearch>> searchAnnotationByKeywordGETUsingGETWithHttpInfo(String keyword, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = searchAnnotationByKeywordGETUsingGETValidateBeforeCall(keyword, limit, null);
     ...
     */
    public okhttp3.Call searchAnnotationByKeywordGETUsingGETAsync(String keyword, Integer limit, final ApiCallback<List<IndexSearch>> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchAnnotationByKeywordGETUsingGETValidateBeforeCall(keyword, limit, _callback);
        Type localVarReturnType = new TypeToken<List<IndexSearch>>(){}.getType();
